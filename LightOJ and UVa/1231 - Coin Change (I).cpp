...
int rec(ll i, ll n)   /// i == index , n == requirement theke komte komte koto hoise...
{
    ...
    /// er mane holo - ami k bar ei coin ta nisi , mane k bar i exactly ei coin ke nisi.
    /// ekhn k bar ei coin ke jodi nei tahole er porer coin ke kivabe nibo setai hisab kortesi.
