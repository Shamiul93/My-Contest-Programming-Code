...
Concept - DP , Knapsack (may be)...
Idea - Once you reach to an element , you have to start the range from here and then you check all
those elements who are less than w distance from it by a for loop. then you call a recursive function
and you get the answer. See the function.
**/
